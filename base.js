...
global.INVALID_LOGIN_REGEX = /Application-specific password|Please log in via your web|Invalid credentials|Web login required|Invalid login or password|Authentication failed|enabled for IMAP use/i
